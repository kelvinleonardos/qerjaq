                ...
                <div class="flex flex-wrap p-2 rounded-lg mt-0 md:mt-14 bg-white shadow dark:bg-gray-800">
                    ...
                    <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <div class="flex flex-col sm:flex-row md:flex-col items-center py-10">
                            <img class="w-24 h-24 mb-3 ml-4 md:ml-0 rounded-full shadow-lg" src="{{ asset("/storage") }}/{{ $d->company->user->profile_pict }}" alt="Company"/>
                            <div class="flex flex-col pl-0 sm:pl-4 items-center sm:items-start md:pl-0 md:items-center">
                                <a href="#">
                                    <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">{{ $d->company->user->name }}</h5>
                                </a>
                                <span class="text-sm text-gray-500 dark:text-gray-400">{{ $d->company->user->most_interest }}</span>
                            </div>
                        </div>
                    </div>
