            ...
            <div class="p-2 mx-2 md:p-4 md:pr-0 md:mr-2 md:w-2/3">
                ...
                <div class="p-2 rounded-lg mt-14 bg-white shadow dark:bg-gray-800">
                    ...
                    @elseif($status == 'update')
                        <div class="p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800">
                            <h2 class="text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white">Update Job</h2>
                            <p class="text-s tracking-tight text-gray-900 dark:text-white">Update job details</p>
                        </div>
                    @endif
                    ...
                    <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        @elseif($status == 'update')
                            <form method="POST" action="/update/{{ $job->id }}" enctype="multipart/form-data">
                                @csrf
                                <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 rounded-t-lg bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800" id="defaultTab" data-tabs-toggle="#defaultTabContent" role="tablist">
                                    <li class="me-2">
                                        <button id="about-tab" type="button" class="inline-block p-4 text-blue-600 rounded-ss-lg hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-blue-500">Job Details</button>
                                ...
                                <div class="p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="about" role="tabpanel" aria-labelledby="about-tab">
                                    ...
                                    <div class="mt-4">
                                        <x-input-label for="name" :value="__('Name')" />
                                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $job->name)" required autofocus autocomplete="name" />
                                        <x-input-error :messages="$errors->get('name')" class="mt-2" />
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        <x-input-label for="position" :value="__('Position')" />
                                        <x-text-input id="position" class="block mt-1 w-full" type="text" name="position" :value="old('position', $job->position)" required autocomplete="position" />
                                        <x-input-error :messages="$errors->get('position')" class="mt-2" />
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        <x-input-label for="address" :value="__('Address')" />
                                        <x-text-input id="address" class="block mt-1 w-full" type="text" name="address" :value="old('address', $job->address)" required autocomplete="address" />
                                        <x-input-error :messages="$errors->get('address')" class="mt-2" />
                                    </div>

                                    <div class="mt-4">
                                        <x-input-label for="city" :value="__('City')" />
                                        <x-text-input id="city" class="block mt-1 w-full" type="text" name="city" :value="old('city', $job->city)" required autocomplete="city" />
                                        <x-input-error :messages="$errors->get('phone')" class="mt-2" />
                                    </div>

                                    <div class="mt-4">
                                        <x-input-label for="country" :value="__('Country')" />
                                        <x-text-input id="country" class="block mt-1 w-full" type="text" name="country" :value="old('country', $job->country)" required autocomplete="country" />
                                        <x-input-error :messages="$errors->get('phone')" class="mt-2" />
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        <x-input-label for="description" :value="__('Description')" />
                                        <x-text-input id="description" class="block mt-1 w-full" type="text" name="description" :value="old('description', $job->description)" required autofocus autocomplete="description" />
                                        <x-input-error :messages="$errors->get('description')" class="mt-2" />
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        <x-input-label for="requirements" :value="__('Requirements')" />
                                        <x-text-input id="requirements" class="block mt-1 w-full" type="text" name="requirements" :value="old('requirements', $job->requirements)" required autofocus autocomplete="requirements" />
                                        <x-input-error :messages="$errors->get('requirements')" class="mt-2" />
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        <x-input-label for="applicants_quota" :value="__('Applicants Quota')" />
                                        <x-text-input id="applicants_quota" class="block mt-1 w-full" type="text" name="applicants_quota" :value="old('applicants_quota', $job->applicants_quota)" required autofocus autocomplete="applicants_quota" />
                                        <x-input-error :messages="$errors->get('applicants_quota')" class="mt-2" />
                                    </div>
                                </div>
                            </form>
