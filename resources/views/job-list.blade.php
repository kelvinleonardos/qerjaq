...
@section("content")
    ...
    <div class="p-4 sm:ml-64">
        <div class="mb-3 mt-14 text-center">
            <a href="/create-job/{{ \Illuminate\Support\Facades\Auth::user()->company->id }}" class="inline-flex items-center justify-center p-5 text-base font-medium text-gray-500 rounded-lg bg-gray-50 hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
                            ...
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                ...
                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="flex flex-row">
                                        ...
                                        <form action="/delete/{{ $j->id }}" method="POST">
                                            @csrf
                                            @method('DELETE')
