<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="profile_pict" :value="__('Profile Picture')" />
        ...
        <div>
            ...
            <x-text-input id="most_interest" name="most_interest" type="text" class="mt-1 block w-full" :value="old('most_interest', $user->most_interest)" required autofocus autocomplete="most_interest" />
            <x-input-error class="mt-2" :messages="$errors->get('most_interest')" />
        </div>
